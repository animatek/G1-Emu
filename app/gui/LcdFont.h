...
namespace g1gui
{
	inline const std::array<std::array<uint8_t, 5>, 96>& lcdFont()
	{
		static const std::array<std::array<uint8_t, 5>, 96> font = {{
			...
			{0x15,0x16,0x7C,0x16,0x15}, {0x00,0x41,0x41,0x7F,0x00}, {0x04,0x02,0x01,0x02,0x04}, {0x40,0x40,0x40,0x40,0x40}, // yen ] ^ _
